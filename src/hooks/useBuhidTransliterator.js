import {
  ...
  toLatin,
  toStandardLatin,
} from "src/utils/transliterator/buhid/transliterate";

const useBuhidTransliterator = (inputText, setInputText, isLatinInput) => {
  const ime = initIME();
...
export default useBuhidTransliterator;
